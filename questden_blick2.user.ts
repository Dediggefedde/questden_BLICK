...
(function () {
  ...
  class WatchBar {
    ...
    private generateLink(thread: threaddata, id: string, curReadInd: number): string {
      let add = "";
      let jump = "";
      ...
      if (targetInd < 50 && thread.totalEntrCnt > 50) add = "+50";
      else if (targetInd < 100 && thread.totalEntrCnt > 100) add = "+100";
      //+50/+100 if possible and target in page.
      
      if(curReadInd==-1 && this.wdata.data.numLinkMode == 1) add="";
          ...
          fetch(`https://questden.org/kusaba/quest/res/${id}.html`)
            ...
            .then(htmlText => {
              ...
              replyElements.forEach((td, ind) => {
                if (thread.currentReadId == td.id) curReadInd = ind;

...
(function () {
            ...
            document.getElementById("BLICK_sync_loggin")?.addEventListener("click", (ev) => {
                ...
                this.syncr.login(nam, pw).then((ret) => {
                    if (ret === true) { //logged in
                        ...
                        if (loginHello)
                            loginHello.innerHTML = "Hello, " + document.getElementById("BLICK_sync_user")?.value + "!";
                    }
                    else {
    ...
    class ImageManager {
        ...
        setupEventListeners() {
            ...
            document.getElementById("BLICK_iP_seachInp")?.addEventListener("keydown", (ev) => { if (ev.key === 'Enter')
                ev.preventDefault(); });
            //
    ...
    class FileExport {
        ...
        filterEntries(cont) {
            ...
            cont.querySelectorAll("div.postwidth").forEach(el => {
                ...
                let elChecked = el.closest("input[type='checkbox'][name='post[]']")?.checked ?? false;
                //
